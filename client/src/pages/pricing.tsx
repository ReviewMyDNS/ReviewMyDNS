  ...
  const plans = [
    {
      ...
      features: [
        ...
        { name: "Single-domain propagation checker", included: true },
        { name: "Basic security scan", included: true },
        { name: "DNS comparison (2 providers)", included: true },
        { name: "Bulk DNS lookup", included: false },
        { name: "Performance analytics", included: false },
        { name: "Historical tracking", included: false },
        { name: "API access", included: false },
        { name: "Export results (CSV/JSON)", included: false },
      ],
    ...
    },
    {
      ...
      features: [
        ...
        { name: "All DNS record types (MX, TXT, SOA, NS, PTR)", included: true },
        { name: "Bulk lookup (500 domains/day)", included: true },
        { name: "30-day historical tracking", included: true },
        { name: "Performance analytics dashboard", included: true },
        { name: "API access (25,000 calls/month)", included: true },
        { name: "Email alerts for DNS changes", included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "5 team seats included", included: true },
        { name: "Shared lookup history", included: true },
        { name: "Scheduled monitoring", included: true },
        { name: "Slack/Webhook integrations", included: true },
        { name: "Advanced alerting rules", included: true },
    ...
    },
    {
      ...
      features: [
        { name: "Everything in Team, plus:", included: true },
        { name: "Unlimited team seats", included: true },
        { name: "SSO authentication (SAML, OAuth)", included: true },
        { name: "Advanced audit logs", included: true },
        { name: "Custom API quotas", included: true },
